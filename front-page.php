            ...
            <div class="swiper villa-swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <article id="daisy" class="villa-card group bg-white overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 cursor-pointer h-full"
                                 data-villa="daisy"
                    ...
                    <!-- Lily Homes -->
                    <div class="swiper-slide">
                        <article id="lily" class="villa-card group bg-white overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-[#b5a191] cursor-pointer h-full"
                                 data-villa="lily"
                ...
                <div class="grid md:grid-cols-2">
                    ...
                    <div class="p-8 md:p-10 lg:p-12">
                        ...
                        <a href="https://wa.me/6281234567890?text=Hello,%20I%20am%20interested%20in%20villa%20investment"
                           ...
                           rel="noopener"
                           id="villa-modal-cta"
                           class="inline-flex items-center gap-3 bg-[#b5a191] hover:bg-[#a08d7a] text-[#514d32] px-8 py-4 text-sm uppercase tracking-[0.15em] font-medium transition-all duration-300 w-full justify-center rounded-full">
            ...
            <div class="relative bg-white w-full max-w-4xl my-8 shadow-2xl animate-modal-in">
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                        <!-- All Facility Items -->
                        <div class="text-center p-6 border border-gray-100 hover:border-[#b5a191] transition-colors group cursor-pointer rounded-2xl" onclick="openFacilityModal('restaurant')">
                            <div class="w-14 h-14 mx-auto mb-4 flex items-center justify-center border border-[#b5a191]/50 group-hover:bg-[#b5a191]/10 transition-colors rounded-full">
                        ...
                        <div class="text-center p-6 border border-gray-100 hover:border-[#b5a191] transition-colors group cursor-pointer rounded-2xl" onclick="openFacilityModal('wellness')">
                            <div class="w-14 h-14 mx-auto mb-4 flex items-center justify-center border border-[#b5a191]/50 group-hover:bg-[#b5a191]/10 transition-colors rounded-full">
                                <svg class="w-6 h-6 text-[#b5a191]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-center p-6 border border-gray-100 hover:border-[#b5a191] transition-colors group cursor-pointer rounded-2xl" onclick="openFacilityModal('coworking')">
                            <div class="w-14 h-14 mx-auto mb-4 flex items-center justify-center border border-[#b5a191]/50 group-hover:bg-[#b5a191]/10 transition-colors rounded-full">
                                <svg class="w-6 h-6 text-[#b5a191]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-center p-6 border border-gray-100 hover:border-[#b5a191] transition-colors group cursor-pointer rounded-2xl" onclick="openFacilityModal('spa')">
                            <div class="w-14 h-14 mx-auto mb-4 flex items-center justify-center border border-[#b5a191]/50 group-hover:bg-[#b5a191]/10 transition-colors rounded-full">
                                <svg class="w-6 h-6 text-[#b5a191]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-center p-6 border border-gray-100 hover:border-[#b5a191] transition-colors group cursor-pointer rounded-2xl" onclick="openFacilityModal('pool')">
                            <div class="w-14 h-14 mx-auto mb-4 flex items-center justify-center border border-[#b5a191]/50 group-hover:bg-[#b5a191]/10 transition-colors rounded-full">
                                <svg class="w-6 h-6 text-[#b5a191]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-center p-6 border border-gray-100 hover:border-[#b5a191] transition-colors group cursor-pointer rounded-2xl" onclick="openFacilityModal('kids')">
                            <div class="w-14 h-14 mx-auto mb-4 flex items-center justify-center border border-[#b5a191]/50 group-hover:bg-[#b5a191]/10 transition-colors rounded-full">
                                <svg class="w-6 h-6 text-[#b5a191]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-center p-6 border border-gray-100 hover:border-[#b5a191] transition-colors group rounded-2xl">
                            <div class="w-14 h-14 mx-auto mb-4 flex items-center justify-center border border-[#b5a191]/50 group-hover:bg-[#b5a191]/10 transition-colors rounded-full">
                                <svg class="w-6 h-6 text-[#b5a191]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<section class="py-24 md:py-32 bg-white">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-16">
            <!-- Benefit 1 -->
            <div class="text-center p-8 border border-gray-100 hover:border-[#b5a191] transition-colors rounded-2xl">
    ...
    <div class="relative z-20 max-w-4xl mx-auto px-6 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <a href="https://wa.me/6281234567890?text=Hello,%20I%20am%20interested%20in%20Terra%20Eden%20Bali%20villa%20investment"
               target="_blank"
               rel="noopener"
               class="inline-flex items-center gap-3 bg-[#b5a191] hover:bg-[#a08d7a] text-[#514d32] px-10 py-5 text-sm uppercase tracking-[0.15em] font-medium transition-all duration-500 rounded-full">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                </svg>
                <span>Request Brochure</span>
            ...
            <a href="#villas"
               class="inline-flex items-center gap-3 bg-transparent border border-white/50 hover:border-white text-white px-10 py-5 text-sm uppercase tracking-[0.15em] font-medium transition-all duration-500 hover:bg-white/10 rounded-full">
